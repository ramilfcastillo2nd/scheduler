...
using scheduler_azure.api.Extensions;
using scheduler_azure.api.Helpers;
using System;
using System.Linq;
using System.Text;

namespace scheduler_azure.api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton(_config.GetSection("AzureBlobSettings").Get<AzureBlobSettings>());
