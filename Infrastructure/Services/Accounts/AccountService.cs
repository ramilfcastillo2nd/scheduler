...
namespace Infrastructure.Services.Accounts
{
    public class AccountService: IAccountService
    {
        ...
        public async Task<ResetPasswordOutputDto> ResetPasswordAsync(AppUser user, string newPassword, string code)
        {
        ...
        public async Task<string> ForgotPasswordAsync(AppUser user)
        {
            string code = await _userManager.GeneratePasswordResetTokenAsync(user);
            code = await ModifySaveGeneratedCode(user, code, TransactionType.forgotpassword);
            return code;
        }
        ...
        public async Task<ConfirmCodeOutputDto> ConfirmEmailAsync(AppUser user, string code)
        {
            var verificationCode = $"{code}{user.LastTwoDigitRegisterConfirmation}";
            var result = await _userManager.ConfirmEmailAsync(user, verificationCode);
            return new ConfirmCodeOutputDto
            {
